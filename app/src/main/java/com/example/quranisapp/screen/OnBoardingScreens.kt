...
private fun OnBoardingContentWelcome(
    ...
    Column(
        ...
        Image(
            ...
            contentDescription = "QURANIS Logo"
        )
        ...
        Text(
            modifier = Modifier.fillMaxWidth(),
            textAlign = TextAlign.Center,
            text = "let's learn what's in the QURANIS App",
...
private fun OnBoardingContentLocation(
    ...
    Column(
        ...
        Text(
            modifier = Modifier.fillMaxWidth(),
            textAlign = TextAlign.Center,
            text = "The QURANIS feature for find your Qibla cardinal directions",
...
//    LaunchedEffect(GlobalState.isDarkMode){
